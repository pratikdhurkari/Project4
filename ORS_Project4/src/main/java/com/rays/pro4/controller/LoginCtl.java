...
public class LoginCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		System.out.println("LoginCtl validate method");
		...
		if (DataValidator.isNull(login)) {
			System.out.println("LoginCtl datavalidator isNull login");
			request.setAttribute("login", PropertyReader.getValue("error.require", "Login Id"));
			pass = false;
		} else if (!DataValidator.isEmail(login)) {
			System.out.println("LoginCtl datavalidator isEmail login");
			request.setAttribute("login", PropertyReader.getValue("error.email", "Login Id"));
			pass = false;
		}
		if (DataValidator.isNull(request.getParameter("password"))) {
			System.out.println("LoginCtl datavalidator isNull password");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("LoginCtl doGet Method");
		...
		System.out.println("Lctl Dont get method");
		ServletUtility.forward(getView(), request, response);
		...
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			...
			try {
				...
				if (bean != null) {
					...
					ServletUtility.setErrorMessage("Invalid LoginId Or/And Password", request);
				}
