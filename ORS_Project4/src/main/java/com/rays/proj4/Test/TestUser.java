...
//		authenticate();
	...
	private static void authenticate() {
		try {
			...
			bean.setLogin("pratikdhurkari@gmail.com");
			bean.setPassword("Pratik@123");
...
//			bean.setId(1);
			...
			bean.setLastName("Rathod");
			bean.setLogin("nikitarathod@gmail.com");
			bean.setPassword("Nikita@123");
			...
			bean.setLock("yes");
			bean.setConfirmPassword("Nikita@123");
